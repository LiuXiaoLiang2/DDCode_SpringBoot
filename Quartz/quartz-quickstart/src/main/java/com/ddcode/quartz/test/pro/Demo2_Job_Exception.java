...
import com.ddcode.quartz.job.pro.HelloJobException;
...
public class Demo2_Job_Exception {
    ...
    public static void main(String[] args) throws SchedulerException, InterruptedException {
        ...
        JobDetail jobDetail = JobBuilder.newJob(HelloJobException.class).withIdentity("job1", "group1")
